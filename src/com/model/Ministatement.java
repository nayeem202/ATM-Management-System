...
public class Ministatement extends javax.swing.JFrame {
    ...
    public Ministatement(int accNu) {
        initComponents();
    ...
    private void displayTable() {
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) statement.getModel();
            Connection conn = DatabaseConnector.connect();
            String sql = "SELECT * FROM transaction_tbl where Account_Number= '" + myaccNumbr + "'";
            // String sql = "SELECT * FROM transaction_tbl where Account_Number=10022";
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[]{Sl, account_number, type, amount, date});
            }
    ...
    private void initComponents() {
        ...
        statement.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51)));
        statement.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        statement.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Sl.", "Account number", "Transaction Type", "Amount", "Date"
            }
        ) {
        ...
        jPanel3.setBackground(new java.awt.Color(244, 91, 108));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/button2/icons8-search-30.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/button2/icons8-printer-34.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM transaction_tbl2 where  Account_Number ='" + myaccNumbr + "' and   Date between ? and ?";
            int rowCount = statement.getRowCount();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String path = "C:\\Users\\Adon\\Desktop\\MiniStatement";
        Document obj = new Document();
        try {
            PdfWriter.getInstance(obj, new FileOutputStream(path + " " + myaccNumbr + " .pdf "));
            obj.open();
            Paragraph paragraph1 = new Paragraph("                                                First State National Bank Limited                                            \n");
            obj.add(paragraph1);
            Paragraph paragraph2 = new Paragraph("                                      Head Office: 12/2, Dhanmondi, Dhaka-1216, Bangladesh.                                \n");
            obj.add(paragraph2);
            Paragraph paragraph3 = new Paragraph("                                                                                              Date:" + dtf.format(now) + "\n\n");
            obj.add(paragraph3);
            Paragraph paragraph4 = new Paragraph("Account Number :" + myaccNumbr + " " + "\n\n\n");
            obj.add(paragraph4);

            PdfPTable customer_table = new PdfPTable(5);
            customer_table.addCell("Sl.");
            customer_table.addCell("Account number");
            customer_table.addCell("Transaction Type");
            customer_table.addCell("Amount");
            customer_table.addCell("Date");

            for (int i = 0; i < statement.getRowCount(); i++) {
                String s = statement.getValueAt(i, 0).toString();
                String acc = statement.getValueAt(i, 1).toString();
                String type = statement.getValueAt(i, 2).toString();
                String amm = statement.getValueAt(i, 3).toString();
                String date = statement.getValueAt(i, 4).toString();

                customer_table.addCell(s);
                customer_table.addCell(acc);
                customer_table.addCell(type);
                customer_table.addCell(amm);
                customer_table.addCell(date);

            }

            obj.add(customer_table);
            ...
            MessageFormat footer = new MessageFormat("Thanks for choosing our service");
            try {
            statement.print(JTable.PrintMode.NORMAL, header,footer);
